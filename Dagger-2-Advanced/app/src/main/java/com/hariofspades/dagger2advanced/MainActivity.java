...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateUsers() {
        Call<com.hariofspades.dagger2advanced.models.Response> randomUsersCall = getRandomUserService().getRandomUsers(10);
        randomUsersCall.enqueue(new Callback<com.hariofspades.dagger2advanced.models.Response>() {
            @Override
            public void onResponse(Call<com.hariofspades.dagger2advanced.models.Response> call, @NonNull Response<com.hariofspades.dagger2advanced.models.Response> response) {
            ...
            @Override
            public void onFailure(Call<com.hariofspades.dagger2advanced.models.Response> call, Throwable t) {
                Log.d("Ngoa", "Failed");
