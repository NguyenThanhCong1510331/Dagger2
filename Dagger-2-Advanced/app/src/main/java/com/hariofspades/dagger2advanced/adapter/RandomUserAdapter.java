...
import com.hariofspades.dagger2advanced.models.ResultsItem;
...
public class RandomUserAdapter extends RecyclerView.Adapter<RandomUserAdapter.RandomUserViewHolder> {
    ...
    private List<ResultsItem> resultList = new ArrayList<>();
    ...
    public void onBindViewHolder(RandomUserViewHolder holder, int position) {
        ResultsItem result = resultList.get(position);
    ...
    public void setItems(List<ResultsItem> results) {
        resultList = results;
